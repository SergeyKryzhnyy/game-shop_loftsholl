                ...
                @if (Route::has('login'))
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        @auth
                            ...
                            <a href="{{ url('/') }}"  class="text-sm text-gray-700 dark:text-gray-500 underline">Выйти{{Auth::logout()}}</a>
                        @else
          ...
          <div class="sidebar-item">
            ...
            <div class="sidebar-item__content">
                @foreach($categories as $category)
                    <li class="sidebar-category__item"><a href="{{$category->name}}" class="sidebar-category__item__link">{{$category->name}}</a></li>
                @endforeach
            </div>
          </div>
          <div class="sidebar-item">
...
{{--                <div class="content-head__title-wrap__title bcg-title">Мои заказы</div>--}}
                  <div class="content-head__title-wrap__title bcg-title">Информация об игре</div>
              </div>
            ...
            <div class="content-main__container">
              <div class="cart-product-list">
                ...
                <div class="cart-product__item__product-photo"><img src="/storage/{{$gameInfo->image}}" class="cart-product__item__product-photo__image"></div>
                  <div class="cart-product__item__product-name">
                  <div class="cart-product__item__product-name__content">{{$gameInfo->name}}</div>

                  </div>
                  <div class="cart-product__item__cart-date">
                    <div class="cart-product__item__cart-date__content">{{$gameInfo->updated_at}}</div>
                  </div>
                  <div class="cart-product__item__product-price"><span class="product-price__value">{{$gameInfo->cost}} руб.</span></div>
                </div>
                  <div class="cart-product__item__product-price"><span class="product-price__value">{{$gameInfo->description}}.</span>
                  </div>
