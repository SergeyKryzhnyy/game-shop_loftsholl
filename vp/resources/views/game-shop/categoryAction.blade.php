      ...
      <header class="main-header">
        ...
        <nav class="main-navigation">
          <ul class="nav-list">
              ...
              <li class="nav-list__item"><a href="{{route('game-shop/news')}}" class="nav-list__item__link">Мои заказы</a></li>
              <li class="nav-list__item"><a href="{{route('game-shop/news')}}" class="nav-list__item__link">Новости</a></li>
              <li class="nav-list__item"><a href={{route('game-shop/about')}} class="nav-list__item__link">О компании</a></li>
          </ul>
        </nav>
                ...
                @if (Route::has('login'))
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        @auth
                            ...
                            <a href="{{ url('/') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Выйти</a>
                        @else
          ...
          <div class="content-middle">
            <div class="content-head__container">
              <div class="content-head__title-wrap">
                ...
                <div class="content-head__title-wrap__title bcg-title">{{$categoryNow}}</div>
              </div>
