          ...
          <div class="content-middle">
            <div class="content-head__container">
              <div class="content-head__title-wrap">
                <div class="content-head__title-wrap__title bcg-title">Оставьте свои данные</div>
              </div>
              ...
              <form action="{{ route('game-shop/sendform', ['game_id'=>$_GET['game_id']])}}" method="post" >
                  <fieldset>
                      ...
                      <label><button class="search-conta iner__form__btn" type="submit">Отправить</button> </label>
                  </fieldset>
              </form>
